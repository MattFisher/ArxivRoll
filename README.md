...
ArxivRollBench releases, the `arxivrollbench` package:

```bash
pip install -e .
inspect eval arxivrollbench/arxivrollbench.py@arxivrollbench --model openai/gpt-5-nano
```
...
```bash
inspect eval arxivrollbench/arxivrollbench.py@arxivrollbench \
